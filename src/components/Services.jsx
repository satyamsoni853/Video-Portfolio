...
const Services = () => {
  ...
  return (
    <section 
      id="services"
      ref={containerRef}
      className="bg-white pt-14 pb-20 md:pt-24 md:pb-32 px-6 md:px-12 w-full relative overflow-hidden font-sans bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:80px_80px]"
    >
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        
        {/* Header Content */}
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-8 md:mb-0">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 leading-[1.1] mb-6 tracking-tight relative">
            Here's how I turn your idea into a production-ready product
            {/* Hand-drawn arrow */}
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard
            number="01"
            title="Discover"
            text="I start by understanding your business goals, user requirements, and technical constraints to lay a rock-solid foundation — gathering every detail before writing a single line of code."
          ...
          <TagCard
            number="02"
            title="Design"
            text="Crafting intuitive, pixel-perfect user interfaces using Tailwind CSS, Figma, and modern design systems — ensuring every screen is accessible, responsive, and visually sharp."
          ...
          <TagCard
            number="03"
            title="Build"
            text="Developing scalable React & Next.js frontends paired with robust Spring Boot backends, secure REST APIs, and optimized PostgreSQL / MongoDB databases."
          ...
          <TagCard
            number="04"
            title="Deploy"
            text="Rigorous testing, performance optimization, and seamless deployment via Docker and cloud infrastructure — followed by ongoing support to keep your product running flawlessly."
