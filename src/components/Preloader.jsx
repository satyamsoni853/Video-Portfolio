    ...
    <AnimatePresence>
      {isLoading && (
        <motion.div
          ...
          className="fixed inset-0 w-full h-screen bg-[#08090f] z-[100000] flex items-center justify-center"
        >
          {/* Logo Container */}
          <motion.div 
          ...
          >
            ...
            <div className="text-slate-900/30">
              Satyam<span className="text-slate-900/30">.</span>
            </div>
            ...
            >
              Satyam<span className="text-black">.</span>
            </motion.div>
          </motion.div>
